...
class UpdateCredentialAllowTest extends BaseTest {
    ...
    public function testCredentialUpdateAllow(){
        ...
        $this->assertTrue(isset($this->calls[Events::onUpdateCredential]));
        $this->assertTrue(isset($this->calls[Events::postUpdateCredential]));
        $this->assertFalse(isset($this->calls[Events::updateCredentialDenied]));
    }

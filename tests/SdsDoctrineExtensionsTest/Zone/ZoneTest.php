...
namespace SdsDoctrineExtensionsTest\Zone;

use SdsDoctrineExtensionsTest\BaseTest;
use SdsDoctrineExtensionsTest\Zone\TestAsset\Document\Simple;
...
class ZoneTest extends BaseTest {
    ...
    protected function getTestDocs(){
        $repository = $this->documentManager->getRepository('SdsDoctrineExtensionsTest\Zone\TestAsset\Document\Simple');

...
namespace Proxies\__CG__\Sds\DoctrineExtensions\Test\Serializer\TestAsset\Document;
 ...
 */
class CakeEagerSimpleReference extends \Sds\DoctrineExtensions\Test\Serializer\TestAsset\Document\CakeEagerSimpleReference implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    public function addIngredient(\Sds\DoctrineExtensions\Test\Serializer\TestAsset\Document\Ingredient $ingredient)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'ingredients', 'flavour');
    }

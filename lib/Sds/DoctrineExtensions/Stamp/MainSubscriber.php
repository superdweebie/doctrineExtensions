...
class MainSubscriber extends AbstractStampSubscriber {
    ...
    public function prePersist(LifecycleEventArgs $eventArgs) {
        ...
        if(isset($metadata->stamp['createdBy'])){
            $metadata->reflFields[$metadata->stamp['createdBy']]->setValue($document, $this->getIdentityName());
        }
        ...
        if(isset($metadata->stamp['updatedBy'])){
            $metadata->reflFields[$metadata->stamp['updatedBy']]->setValue($document, $this->getIdentityName());
        }
